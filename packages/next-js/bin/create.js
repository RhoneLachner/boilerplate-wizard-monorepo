...
async function main() {
  ...
  if (!projectName || projectName === '--help' || projectName === '-h') {
    log('\n🧙‍♂️ Boilerplate Wizard - Next.js + JavaScript\n', 'cyan');
    log('Usage:', 'bright');
    log('  npm create bp-wizard-next-js <project-name>', 'blue');
    log('  npx create-bp-wizard-next-js <project-name>', 'blue');
    log('\nExample:', 'bright');
    log('  npm create bp-wizard-next-js my-next-app', 'green');
    return;
  }
  ...
  try {
    log(`\n🧙‍♂️ Creating Next.js + JavaScript project: ${projectName}\n`, 'cyan');
    ...
    log(`📁 Template: Next.js + JavaScript\n`, 'blue');

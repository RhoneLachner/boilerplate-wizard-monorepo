export default function About() {
  ...
  const devCommands = [
    { command: 'npm run build', description: 'Builds the app for production with optimizations' },
    { command: 'npm start', description: 'Starts the production server' },
    { command: 'npm test', description: 'Runs unit tests using Jest' },
    { command: 'npm run test:e2e', description: 'Executes end-to-end tests with Playwright' },
    { command: 'npm run lint', description: 'Lints the entire codebase with Next.js ESLint' },

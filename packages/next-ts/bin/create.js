...
async function main() {
  ...
  if (!projectName || projectName === '--help' || projectName === '-h') {
    log('\n🧙‍♂️ Boilerplate Wizard - Next.js + TypeScript\n', 'cyan');
    log('Usage:', 'bright');
    log('  npm create bp-wizard-next-ts <project-name>', 'blue');
    log('  npx create-bp-wizard-next-ts <project-name>', 'blue');
    log('\nExample:', 'bright');
    log('  npm create bp-wizard-next-ts my-next-app', 'green');
    return;
  }
  ...
  try {
    log(`\n🧙‍♂️ Creating Next.js + TypeScript project: ${projectName}\n`, 'cyan');
    ...
    log(`📁 Template: Next.js + TypeScript\n`, 'blue');

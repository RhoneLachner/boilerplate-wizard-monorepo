...
async function main() {
  ...
  if (!projectName || projectName === '--help' || projectName === '-h') {
    log('\n🧙‍♂️ Boilerplate Wizard - React + TypeScript\n', 'cyan');
    log('Usage:', 'bright');
    log('  npm create bp-wizard-react-ts <project-name>', 'blue');
    log('  npx create-bp-wizard-react-ts <project-name>', 'blue');
    log('\nExample:', 'bright');
    log('  npm create bp-wizard-react-ts my-react-app', 'green');
    return;
  }
  ...
  try {
    log(`\n🧙‍♂️ Creating React + TypeScript project: ${projectName}\n`, 'cyan');
